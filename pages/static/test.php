  ...
  $nomcommande = $_GET['nomcommande'];
    ...
    $rowcount=mysqli_num_rows($res);
        if($rowcount<1){
            ...
            VALUES 
            ('$IDType','$IDNumber','$IDExpiration','$LastName','$FirstName','$pseudonyme','$RaisonSociale','$matricule','$qualites','$qrcode','$DateAdhesion','$City','$Country','$State','$PostalCode','$DateOfBirth','$EmailAddress','$HomePhone','$OfficePhone','$MobilePhone','$PhotoReference','$SalaryID','$SolID','$IDImage','$nomcommande')";
            ...
            header("Location:test.php?msg=0&&nomcommande=$nomcommande");
        }
    }
}
?>
        ...
        <form action="" method="post" style="width:50vw; min-width: 300px;">
            ...
            <?php
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control fw-bold" required name="LastName">
                </div>
                <div class="col">
            ...
            <div class="row  mt-3">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control fw-bold" required name="matricule">
                </div>
            </div>
...
<select class="form-select form-select-sm"name="Country" required aria-label=".form-select-sm">
  <option value="">Choisir pays</option>
	...
	<?php } ?>		
                    ...
                    <!--input type="text" class="form-control fw-bold" name="Country"-->
                </div>
            </div>
            ...
            <div class="row  mt-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control fw-bold" name="MobilePhone">
                </div>
                <div class="col">
                    <label class="form-label fw-bold">Telephone  :</label>
                    <input type="text" class="form-control fw-bold" name="OfficePhone">
                </div>
            </div>
