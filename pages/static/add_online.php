...
if (isset($_POST['Ajouter'])) {
    $statut = 'OK';
    $sql = "UPDATE enligne SET statut='$statut'  WHERE matricule='$matricule' ";
    $result = mysqli_query($conn, $sql);
}
...
<div class="container">
        ...
        //$sql = "SELECT * FROM compilcartes WHERE matricule=$matricule";
					...
					<div class="card">
						...
						<form method='POST'>
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									<input type="submit" name='Ajouter' class="btn btn-primary px-4" value="Sauvegarder les Changements">
								</div>
							</div>
						</div>
					</div>
