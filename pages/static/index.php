		...
		<?php include "entete.php"; ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Analyse</strong> Tableau de Bord</h1>
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Cartes produites</h5>
													</div>
												...
												<div class="mb-0">
													...
													<span class="text-muted">Dernière semaine</span>
												</div>
											</div>
										</div>
										<div class="card">
						...
						<div class="col-xl-6 col-xxl-7">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Recents Mouvements</h5>
								</div>
							...
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0">
									...
									while ($row = mysqli_fetch_assoc($result)) {?>
										<tr>
											<td><?php echo $nomcommande=$row['nomcommande']; ?> </td>
						...
						<div class="col-12 col-lg-4 col-xxl-3 d-flex">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Production Mensuelle</h5>
								</div>
...
<script>
	const xArray = ["Musique", "Audio Visuel", "Litterature", "Art Dramatique", "Art Visuel","Voisins"];
...
<script>
	const xArray2 = ["Musique", "Audio Visuel", "Litterature", "Art Dramatique", "Art Visuel","Voisins"];
	const yArray2 = [100, 49, 30, 40, 66,49];
	const layout2 = {title:"Production des Cartes de Membre"};
...
<script src="js/b0d0eaa2c0.js" crossorigin="anonymous"></script>
