...
<div class="wrapper">
 ...
 <div class="container">
    ...
    <table id="example" class="display" style="width:100%">
        ...
        <?php
        include "../db_conn.php";
        $sql = "SELECT * FROM compilcartes ORDER BY id DESC";
        ...
        while ($row = mysqli_fetch_assoc($result)) {?>
            ...
            <tr>
                ...
                <td align='left'><?php echo $row['DateCommande'] ?></td>
                <td>
                <?php 
                    ...
                    <a href="retire.php?id=<?php echo $row['id'] ?>" class="link-danger">
                    <i class="align-middle" data-feather="external-link"></i>
                    </a>
                <?php 	} ?>
                    </td>
                            <td>
                            <a href="add_old.php?id=<?php echo $row['id'] ?>&&matricule=<?php echo $row['matricule'] ?>" class="link-success">
